...
export default function BasePageHeader() {
  ...
  return (
    <header className="flex items-center w-full bg-white flex-none shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_0_2px_0_rgba(0,0,0,0.08),0_1px_3px_0_rgba(0,0,0,0.08)] relative" style={{ height: '56px', zIndex: 20 }}>
      <nav className="flex items-center w-full pl-2 pr-4">
        {/* Left section */}
        <div className="flex items-center" style={{ flexBasis: '0%', flexGrow: 1, flexShrink: 1, minWidth: '170px' }}>
          <div className="flex flex-auto items-center">
            {/* Sidebar toggle button */}
            <button
              onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
              className="flex pointer hover:bg-black/5 rounded"
              aria-label="Collapse sidebar"
              style={{ height: '20px', paddingLeft: '4px', paddingRight: '8px' }}
            >
              <svg width="20" height="20" viewBox="0 0 16 16" className="flex-none opacity-50 hover:opacity-100" style={{ shapeRendering: 'geometricPrecision' }}>
                <use fill="currentColor" href="/icons/icon_definitions.svg#List"></use>
              </svg>
            </button>
        ...
        <div className="flex justify-center" style={{ flexBasis: '0%', flexGrow: 1, flexShrink: 1, maxWidth: '354px' }}>
          <div className="flex items-center w-full">
            <button
              className="rounded-full bg-white shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_0_2px_0_rgba(0,0,0,0.08),0_1px_3px_0_rgba(0,0,0,0.08)] hover:shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_2px_4px_0_rgba(0,0,0,0.08),0_4px_8px_0_rgba(0,0,0,0.08)] px-4 flex items-center pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 w-full"
              style={{ height: '32px' }}
              aria-label="Search"
            >
              <svg width="16" height="16" viewBox="0 0 16 16" className="flex-none" style={{ shapeRendering: 'geometricPrecision' }}>
                <use fill="currentColor" href="/icons/icon_definitions.svg#MagnifyingGlass"></use>
              </svg>
              <p className="ml-2 flex-auto text-left text-gray-500 text-[13px] leading-[19.5px]">Search...</p>
              <p className="ml-2 text-gray-400 text-[13px] leading-[19.5px]">ctrl K</p>
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center" style={{ flexBasis: '0%', flexGrow: 1, flexShrink: 1, minWidth: '170px' }}>
          <div className="flex-auto flex items-center">
            <div className="flex-auto flex items-center justify-end">
              {/* Help button */}
              <button
                className="flex items-center justify-center rounded-full pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 hover:bg-black/5"
                style={{ height: '28px', width: '28px' }}
                aria-label="Help menu"
              >
                <svg width="16" height="16" viewBox="0 0 16 16" className="flex-none" style={{ shapeRendering: 'geometricPrecision' }}>
                  <use fill="currentColor" href="/icons/icon_definitions.svg#Question"></use>
                </svg>
              </button>

              {/* Notifications button */}
              <button
                className="relative flex items-center rounded-full pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                style={{ height: '28px', width: '28px', margin: '0 0.75rem' }}
                aria-label="No unseen notifications"
              >
                <div className="flex shrink-0 items-center justify-center rounded-full shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_0_2px_0_rgba(0,0,0,0.08),0_1px_3px_0_rgba(0,0,0,0.08)] hover:shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_2px_4px_0_rgba(0,0,0,0.08),0_4px_8px_0_rgba(0,0,0,0.08)]" style={{ height: '28px', width: '28px' }}>
                  <div className="relative flex flex-col items-center">
                    <div className="relative justify-center inline-block" style={{ top: '-2px', right: '-12px' }}>
                      <div className="rounded-full flex items-center justify-center bg-gray-800" style={{ height: '11px', width: '100%', visibility: 'hidden' }}>
                        <div className="flex items-center justify-center rounded-full p-1 text-white" style={{ height: '9px', lineHeight: '9px', fontSize: '8px' }}>0</div>
                      </div>
                    </div>
                    <div className="relative flex justify-center items-center" style={{ height: '18px', width: '18px', top: '-5px' }}>
                      <svg width="16" height="16" viewBox="0 0 16 16" className="flex-none" style={{ shapeRendering: 'geometricPrecision' }}>
                        <use fill="currentColor" href="/icons/icon_definitions.svg#Bell"></use>
                      </svg>
                    </div>
                  </div>
                </div>
              ...
              {/* Account button */}
              <button
                className="flex-none flex items-center ml-2 rounded-full shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_0_2px_0_rgba(0,0,0,0.08),0_1px_3px_0_rgba(0,0,0,0.08)] hover:shadow-[0_0_1px_0_rgba(0,0,0,0.32),0_2px_4px_0_rgba(0,0,0,0.08),0_4px_8px_0_rgba(0,0,0,0.08)] pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                aria-label="Account"
              >
                <div className="flex items-center">
                  <div className="flex items-center">
                    <div style={{ width: '28px', height: '28px' }}>
                      <div
                        role="img"
                        aria-label={userInitial}
                        className="rounded-full bg-orange-600 border border-white relative"
                        style={{ width: '28px', height: '28px' }}
                      >
                        <div className="flex items-center justify-center text-white text-[13px] leading-[26px] font-normal" style={{ height: '26px', width: '26px' }}>
                          {userInitial}
                        </div>
                      </div>
                    </div>
